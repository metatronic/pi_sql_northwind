...
BEGIN
	BEGIN TRY
		...
		VALUES(@LASTNAME, @FIRSTNAME, @TITLE, @TITLEOFCOURTESY , @BIRTHDAY, @HIREDATE, @ADDRESS, @CITY, @REGION, @POSTALCODE, @COUNTRY)
	END TRY
	BEGIN CATCH
...
EXEC INSERT_EMPLOYEE  'SAHA','PRAN','TRAINEE','MR.','1996-08-27','2021-08-02','MUMBAI','MUMBAI','WA','400064','INDIA'
